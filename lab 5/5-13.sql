...
USE cd;
SELECT ROW_NUMBER() OVER (ORDER BY joindate) AS 'Номер', memid AS 'Идентификатор участника', CONCAT(firstname,' ', surname) AS 'ФИО', joindate AS 'Дата присоединения' FROM members
ORDER BY joindate;
